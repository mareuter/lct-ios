//
//  LunarIIFeaturesTableViewController.swift
//  LunarClubTools
//
...
class LunarIIFeaturesTableViewController: UITableViewController, UIUpdatable, UIPopoverPresentationControllerDelegate
{
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return lunarIIClubInfo?.features.count ?? 0
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "LunarFeature", for: indexPath)
        cell.textLabel?.text = lunarIIClubInfo?.features[indexPath.row].name
        return cell
    }
    ...
    override func tableView(_ tableView: UITableView, accessoryButtonTappedForRowWith indexPath: IndexPath) {
        ...
        if let seguedToMvc = destination?.contents as? LunarFeatureViewController,
            ...
            seguedToMvc.lunarFeature = lunarIIClubInfo?.features[indexPath.row]
